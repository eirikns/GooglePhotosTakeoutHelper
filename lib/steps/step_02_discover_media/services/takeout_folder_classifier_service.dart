...
class TakeoutFolderClassifierService {
  ...
  static const String photosFromPattern = r'Photos from|Fotos del|Fotos von|Foto da|Bilder fra';
  ...
  static const String yearFolderPattern =
      r'^(Photos from|Fotos del|Fotos von|Foto da|Bilder fra) \d{4}$';
  ...
  static const String localizedYearPattern =
      r'photos\s+from|fotos\s+del|fotos\s+von|Foto\s+da|bilder\s+fra';
